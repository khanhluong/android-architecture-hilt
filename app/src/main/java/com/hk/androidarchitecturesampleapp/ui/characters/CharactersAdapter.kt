...
import com.hk.androidarchitecturesampleapp.databinding.ItemCharacterBinding
...
class CharactersAdapter(private val listener: CharacterItemListener) :
    ...
    override fun onBindViewHolder(holder: CharacterViewHolder, position: Int) = holder.bind(item = items[position])
